                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(country.code, style: AppTextStyles.small),
                                ],
                              ),
                            ),
                          ),
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 4),
                          Text(
                            'Recharge: USD ${state.quote!.providerAmount.toStringAsFixed(2)}',
                            style: AppTextStyles.body,
                          ),
                          const SizedBox(height: 4),
                          Text(
                            'TiCash service fee: USD ${state.quote!.feeUsd.toStringAsFixed(2)}',
                            style: AppTextStyles.body,
                          ),
                          const SizedBox(height: 4),
                          Text(
                            'Total: USD ${state.quote!.totalChargeUsd.toStringAsFixed(2)}',
                            style: AppTextStyles.body,
                          ),
                          const SizedBox(height: 12),
                          FilledButton(
                      ...
                      (transaction) => Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            const SizedBox(height: 2),
                            Text(transaction.productName, style: AppTextStyles.small),
                            const SizedBox(height: 2),
                            Text(transaction.status, style: AppTextStyles.small),
                          ],
                        ),
                      ),
                    ),
